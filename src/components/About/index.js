...
const About = () => (
  ...
  <div className="about">
    ...
    <p className="about__desc">
      ...
      Peu importe où vous habitez en France, Bandify se chargera de vous proposer
      des profils adaptés en fonction de votre recherche, et de vos besoins.
      Bandify a pour ambitions de faciliter l'échange et le partage autour
      de la musique, et vous proposons un service de messagerie instantanée.
    </p>
